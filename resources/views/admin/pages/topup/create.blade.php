                            ...
                            <form action="" method="POST" enctype=multipart/form-data>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="input_student_num" placeholder=""
                                            value="{{ old('student_number') }}" name="student_number" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="input_balance" placeholder=""
